      ...
      <div class="table-responsive">
        <table class="table table-striped" aria-describedby="Jvm gc">
          <thead>
            <tr>
              <th scope="col"></th>
              <th scope="col" class="text-right">计数</th>
              <th scope="col" class="text-right">平均值</th>
              <th scope="col" class="text-right">最小值</th>
              ...
              <th scope="col" class="text-right">最大值</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    >
      <thead>
        <tr>
          <th scope="col">状态码</th>
          <th scope="col">次数</th>
          <th scope="col" class="text-right">平均数</th>
    ...
    <div class="table-responsive" v-if="!updatingMetrics && isObjectExistingAndNotEmpty(metrics, 'databases')">
      <table class="table table-striped" aria-describedby="Connection pool">
        <thead>
          <tr>
            <th scope="col">
              <span>用法</span> (active: {{ metrics.databases.active.value }}, min: {{ metrics.databases.min.value }}, max:
