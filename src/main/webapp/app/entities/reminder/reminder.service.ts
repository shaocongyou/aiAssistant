...
export default class ReminderService {
  ...
  public create(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
  ...
  public update(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IReminder): Promise<IReminder> {
    return new Promise<IReminder>((resolve, reject) => {
      axios
